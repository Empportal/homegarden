...
@RestController
@RequestMapping("/api/homegarden-app-kafka")
public class HomegardenAppKafkaResource {
    private final Logger log = LoggerFactory.getLogger(HomegardenAppKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public HomegardenAppKafkaResource(KafkaProperties kafkaProperties) {
